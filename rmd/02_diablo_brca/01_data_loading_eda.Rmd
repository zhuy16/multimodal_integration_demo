...
# NOTE: this split provides mRNA + miRNA only; proteomics is not available.
X_test <- list(
...
# 1) Value-level missingness: NA entries INSIDE available block matrices
# 2) Block-level missingness: an entire omics view absent for some samples
...
cat("\nInterpretation:\n")
cat("- NA counts can be near-zero inside available matrices.\n")
cat("- Proteomics is still missing at block level in the test split (entire view unavailable).\n")
```
