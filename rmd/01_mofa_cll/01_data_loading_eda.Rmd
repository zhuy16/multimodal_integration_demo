...
A key strength: MOFA+ handles **incomplete multi-omics data** where patients lack one or
more views. The CLL_data object used here has been pre-curated to a 200-sample
complete-case intersection, so all four views are present for every patient — the
availability heatmap will appear entirely blue. In real-world cohorts you would
typically see partial coverage (grey cells).
